...
function App() {
  const [currentView, setCurrentView] = useState<"home" | "search" | "details" | "favorites" | "auth" | "account">(
    "home",
  )
  ...
  const goToDetails = (recipeId: string) => {
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="site-header">
        <div className="header-container">
          <div className="site-logo" onClick={goToHome}>
            Ready2Cook
          </div>
          <nav className="nav-menu">
            ...
            <button onClick={goToFavorites} className="nav-link">
              Favoris
            </button>
            {isLoggedIn ? (
              <>
              ...
              <button onClick={() => goToAuth("login")} className="nav-link">
                Connexion
              </button>
            )}
          </nav>
          <button className="primary-button" onClick={goToSearch}>
            Trouver une recette
          </button>
        </div>
      </header>
      ...
      {currentView === "home" && (
        <>
          ...
          <section
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1543353071-873f17a7a088?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')",
            }}
          >
            ...
            <div className="hero-content">
              ...
              <button className="secondary-button" onClick={goToSearch}>
              ...
              <div className="features-container">
                <div className="feature-card">
                  ...
                  <p className="feature-description">
                    Trouvez des recettes instantanément en entrant quelques ingrédients.
                  </p>
                </div>
                <div className="feature-card">
                ...
                {[1, 2, 3].map((i) => (
                  <div key={i} className="testimonial-card">
                    <div className="testimonial-header">
                      <img src={`https://i.pravatar.cc/50?img=${i}`} alt={`User ${i}`} className="testimonial-avatar" />
